...
gdal_translate -tr 0.000070 0.000070 -r cubicspline -of GTiff imagens.vrt teste.tif

gdaldem hillshade -co TILED=YES -co compress=lzw -s 111120 -z 1.5 -az 45 -combined -compute_edges teste.tif final.tif
gdaladdo -r cubicspline --config GDAL_TIFF_OVR_BLOCKSIZE 512 final.tif 2 4 8 16 32
